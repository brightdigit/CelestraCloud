...
struct RobotsTxtServiceTests {
    ...
    private func testParseContent(_ service: RobotsTxtService, content: String) async -> RobotsTxtService.RobotsRules {
        ...
        for line in lines {
            ...
            case "user-agent":
                ...
                isRelevantUserAgent = agentPattern == "*" ||
                                    agentPattern == "celestra" ||
                                    agentPattern.contains("celestra")
